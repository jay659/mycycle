    ...
    <div className="container-fliud pt-50">
      ...
      <table className="table-fill" width="100%">
        ...
        <tbody className="table-hover">
          <tr>
            <td><img src="https://content.jdmagicbox.com/comp/ahmedabad/m4/079pxx79.xx79.161117204233.n9m4/catalogue/mybyk-terminal-shivranjani-brts-ahmedabad-bicycle-on-hire-r1zqlw2k2r.jpg" alt="detail-cycle-view" width="100" /></td>
